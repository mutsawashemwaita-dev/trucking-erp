...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-trucking-erp-change-in-production')
DEBUG = config('DEBUG', default=True, cast=bool)
ALLOWED_HOSTS = ['localhost', '127.0.0.1', '.railway.app', 'trucking-erp-production.up.railway.app', '*']
